...
class FamilyDetailsPagerAdapter(var context:Context, fm: FragmentManager?) : FragmentPagerAdapter(fm!!) {
    ...
    override fun getPageTitle(position: Int): CharSequence? {
        ...
        return when (position) {
            ...
            1 -> context.getString(R.string.meals)
            2 -> context.getString(R.string.wears)
            3 -> context.getString(R.string.furniture)
            4 -> context.getString(R.string.electrical_devices)
            else -> null
        }
    }
